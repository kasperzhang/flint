...
interface ScaffoldPlaygroundChatProps {
  scaffoldContext: string;
  onMessagesChange?: (messages: UIMessage[]) => void;
}

export function ScaffoldPlaygroundChat({
  scaffoldContext,
  onMessagesChange,
}: ScaffoldPlaygroundChatProps) {
    ...
    () =>
      new DefaultChatTransport({
        ...
        body: () => {
          ...
          const basePrompt = state.customMentorPrompt || getMentorSystemPrompt(state.phase);
          const context = `\n\n<scaffold_context>\n${scaffoldContext}\n</scaffold_context>`;
          const scaffoldHtml = state.currentScaffold
            ? `\n\n<current_scaffold_html>\n${stripScaffoldForContext(state.currentScaffold)}\n</current_scaffold_html>`
            : "";
          return {
            sessionId: null,
            phase: state.phase,
            customSystemPrompt: basePrompt + context + scaffoldHtml,
          };
        },
      }),
    [scaffoldContext]
